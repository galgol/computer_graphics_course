...
public:
	...
	//void Update(glm::mat4 MVP,glm::mat4 Normal,glm::vec3 lightColor,glm::vec2 textcoord);
	unsigned int getID();

	void texturing(int texture, GLuint textures);
	void Update(glm::mat4 MVP, glm::mat4 Normal, glm::vec3 lightColor, int texture, GLuint textures);
